...
$('#checkboxAccept').on('click', () => {
	$('#btnFinish').css('visibility', $('#checkboxAccept').is(':checked') ? 'visible' : 'hidden');
});
...
$('#btnFinishInstallation').on('click', function() {
	...
	data.append('device_model', 'batterX traX');

	if(dataObj.hasOwnProperty('box_serial'            ) && dataObj['box_serial'            ] != "") data.append('system_serial'         , dataObj['box_serial'              ]);
	if(dataObj.hasOwnProperty('box_serial'            ) && dataObj['box_serial'            ] != "") data.append('device_serial'         , dataObj['box_serial'              ]);
